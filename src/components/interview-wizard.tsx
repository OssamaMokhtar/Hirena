...
const INTERVIEW_QUESTIONS: Record<string, string[]> = {
  ...
  "data-engineer": [
    "Describe a data pipeline you built from source to destination. What tools and architecture did you choose?",
    "Tell me about a time when data quality issues threatened a project. How did you identify and fix them?",
    "How do you approach choosing between batch processing and real-time streaming for a use case?",
    "Describe a situation where you had to optimize a slow SQL query or data transformation. What was the root cause?",
    "Tell me about your experience with data modeling and how you design schemas for analytics vs operational workloads.",
  ],
  "software-architect": [
    "Walk me through a system architecture you designed from scratch. What were the key trade-offs?",
    "Tell me about a time when you had to migrate a monolith to microservices or decided NOT to. What drove the decision?",
    "How do you evaluate technology choices for a new project? Walk me through your framework.",
    "Describe a production incident caused by an architectural decision. What did you learn?",
    "Tell me about a time you had to balance technical debt against delivery speed. How did you decide?",
  ],
  "tech-lead": [
    "Describe your approach to leading a technical team. How do you balance hands-on coding with architecture and mentoring?",
    "Tell me about a time when you had to resolve a technical disagreement within your team. How did you reach consensus?",
    "How do you ensure code quality across a team without becoming a bottleneck yourself?",
    "Describe a situation where you had to make a technical decision with incomplete information. What was your process?",
    "Tell me about a time you coached a junior engineer through a difficult problem. What was the outcome?",
  ],
  "engineering-manager": [
    "Describe your approach to managing an engineering team. How do you balance people growth with delivery?",
    "Tell me about a time when you had to handle an underperforming team member. What steps did you take?",
    "How do you prioritize technical debt, feature work, and team development when everything is competing for time?",
    "Describe a situation where you had to advocate for your team's needs with senior leadership.",
    "Tell me about a time you had to reorganize a team or restructure responsibilities. How did you manage the transition?",
  ],
  "business-consultant": [
    "Describe a consulting engagement where you had to quickly understand a new industry. How did you accelerate your learning?",
    "Tell me about a time when your recommendation was initially rejected by the client. How did you build trust?",
    "How do you structure a discovery phase to identify the real problem versus the stated problem?",
    "Describe a situation where you had to deliver bad news to a client. How did you approach the conversation?",
    "Tell me about a time you used data to change a client's perspective on a strategic decision.",
  ],
  "ux-ui-designer": [
    "Describe a design project where user research significantly changed your initial approach. What did you learn?",
    "Tell me about a time when you had to defend a design decision to stakeholders who had different opinions.",
    "How do you balance user needs, business constraints, and technical feasibility when designing a feature?",
    "Describe your process for designing a complex user flow from research through high-fidelity mockups.",
    "Tell me about a design improvement you made that had a measurable impact on user behavior or metrics.",
  ],
  "scrum-master": [
    "Describe a team that was struggling with Scrum. What patterns did you observe and how did you help them improve?",
    "Tell me about a time when a sprint went off track. What did you do to get it back on course?",
    "How do you handle a product owner who consistently overwrites the sprint backlog mid-sprint?",
    "Describe your approach to facilitating retrospectives that actually lead to meaningful change.",
    "Tell me about a time you had to coach an organization on Agile practices beyond a single team.",
  ],
  "data-scientist": [
    "Describe a machine learning model you built that had significant business impact. Walk me through the full lifecycle.",
    "Tell me about a time when your model performed well in development but failed in production. What happened?",
    "How do you approach feature engineering for a new problem with limited domain knowledge?",
    "Describe a situation where you had to choose between a simple interpretable model and a complex high-performance one.",
    "Tell me about a time you had to explain a complex ML concept to a non-technical stakeholder.",
  ],
  "ml-engineer": [
    "Describe an ML system you put into production. How did you handle serving, monitoring, and rollback?",
    "Tell me about a time when model inference latency was a problem. How did you optimize it?",
    "How do you approach the trade-off between model accuracy and inference cost in production?",
    "Describe your experience with ML pipelines: data validation, training orchestration, model versioning, and deployment.",
    "Tell me about a situation where you had to implement CI/CD for machine learning models.",
  ],
  "security-engineer": [
    "Describe a security review you conducted for an application. What vulnerabilities did you find and how did you prioritize them?",
    "Tell me about a time when you had to respond to a security incident. What was your process?",
    "How do you balance security controls with developer velocity? Give a specific example.",
    "Describe your approach to threat modeling for a new system. What framework do you use?",
    "Tell me about a time you implemented a security control that was initially unpopular with developers. How did you gain buy-in?",
  ],
  "cloud-architect": [
    "Describe a cloud architecture you designed for a large-scale system. What were the key design decisions?",
    "Tell me about a time when cloud costs spiraled out of control. How did you identify and fix the issue?",
    "Tell me about a time when you had to design for multi-region resilience or disaster recovery.",
    "How do you approach infrastructure-as-code? What tools and patterns do you use for managing cloud resources?",
    "Describe a situation where you had to optimize cloud resource utilization without sacrificing performance or reliability.",
  ],
};
